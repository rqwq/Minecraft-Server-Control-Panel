...
/**
 * Solid brand logos (GitHub, Discord). Unlike the stroke icons above these are
 * filled silhouettes — the standard mark paths from the CC0 simple-icons set.
 */
export type BrandIconName = 'github' | 'discord'
...
export function BrandIcon({ name, size = 16 }: BrandIconProps): JSX.Element {
  return (
    <svg
      className="icon"
      width={size}
